...
subtitle: "Datasheet session for Stillbirth: A Patterned Medical Condition"
author: 
  - Xiaoguang He
thanks: "Code and data are available at: https://github.com/BellHe-hub/PatternStillbirth.git"
...
1. *For what purpose was the dataset created? Was there a specific task in mind? Was there a specific gap that needed to be filled? Please provide a description.*
    - The dataset is created to record the cases of stillbirth. The dataset is created for the purpose of knowing the trends and pattern probably
2. *Who created the dataset (for example, which team, research group) and on behalf of which entity (for example, company, institution, organization)?*
    - The dataset resides in an Oracle database within the City's environment. It is created in compliance with the Vital Statistics Act, which is provincial legislation, and also supports the City's operational requirements and business functions.
...
1. *What do the instances that comprise the dataset represent (for example, documents, photos, people, countries)? Are there multiple types of instances (for example, movies, users, and ratings; people and interactions between them; nodes and edges)? Please provide a description.*
	- The instances that comprise the dataset represent lives, deceased baby with various causes. And this is the main instances of this dataset.
